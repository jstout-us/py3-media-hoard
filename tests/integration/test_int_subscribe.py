...
# def test_subscribe_rss():
#     fix_rss = 'tests/_fixtures/feeds/behind_the_bastards.rss'
#     expected_title = 'Behind the Bastards'
#     expected_new_items = 173

#     title, new_items = media_hoard.subscribe(fix_rss)

#     assert expected_title == title
#     assert expected_new_items == new_items
